...
<html lang="pt-br">
	...
	<body>
			...
			<img src="img/shoes.jpg"  height="25%" width="100%">
			<button class="myButton">Alterar</button>
			<button class="myButton">Excluir </button>
			...
			<center>
			<div id="demoFont">Receba Ofertas Exclusivas</div>
			</br>
			</center>
			<form  method="post" action="#">
			<center>
			<input class="enjoy-css" placeholder="Nome " name="nome" />
			<input class="enjoy-css" placeholder="Email " name="email" />
			</center>
			</form>
			</td>
			</tr>
			...
			<center><a href="#" class="myButton">Enviar</a></center>
			<br>
			</br>
			</td>
			</table>
